...
__all__ = [
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPIAudioStreamPosition',
    'Speech_Max_Word_Length', 'DISPID_SPCPhoneToId',
    'DISPID_SGRs_NewEnum', 'ISpeechPhraseInfo', 'ISpResourceManager',
    'DISPID_SPRuleName', 'DISPID_SRRecognizer',
    'DISPID_SLGetPronunciations', 'LONG_PTR',
    'SpeechEmulationCompareFlags', 'SPBO_NONE',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpLexicon', 'SRESoundEnd',
    'DISPID_SpeechLexiconPronunciation', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SDKSetStringValue', 'SAFT22kHz16BitMono',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SASFreeBufferSpace',
    'SWTDeleted', 'SPEI_SR_AUDIO_LEVEL', 'SVSFDefault',
    'DISPID_SVSCurrentStreamNumber', 'SGLexicalNoSpecialChars',
    'SPPS_SuppressWord', 'DISPID_SpeechRecoResultTimes',
    'SpeechWordType', 'SPVOICESTATUS', 'DISPID_SPPName',
    'DISPID_SPEAudioTimeOffset', 'SPDATAKEYLOCATION',
    'ISpeechDataKey', 'DISPID_SpeechXMLRecoResult', 'SGLexical',
    'ISpeechRecognizerStatus', 'SPEI_START_INPUT_STREAM', 'SVP_11',
    'eLEXTYPE_PRIVATE15', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SpeechLexiconWord', 'SLODynamic', 'DISPIDSPRG',
    'SAFTExtendedAudioFormat', 'SVSFParseAutodetect',
    'Speech_Default_Weight', 'DISPID_SpeechPhraseRules',
    'SVEAllEvents', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPCLangId', 'ISpRecoGrammar', 'DISPID_SLPPartOfSpeech',
    'SVSFIsFilename', 'SPAS_CLOSED', 'SVSFParseSsml',
    'DISPID_SMSALineId', 'DISPID_SDKDeleteValue', 'DISPID_SPEsItem',
    'SAFTGSM610_11kHzMono', 'SpMMAudioIn', 'SGDSActive',
    'DISPID_SLPsItem', 'SRSActiveAlways', 'DISPID_SABIBufferSize',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPPHRASEREPLACEMENT',
    'SRAExport', 'DISPID_SRCERecognitionForOtherContext',
    'SRERequestUI', 'DISPID_SPEPronunciation', 'SGDisplay',
    'SPWAVEFORMATTYPE', 'SWPKnownWordPronounceable',
    'SpeechAudioState', 'SPWORDPRONOUNCEABLE', 'SAFT24kHz16BitStereo',
    'SPBO_AHEAD', 'SPINTERFERENCE_NOISE', 'SPAS_STOP',
    'DISPID_SGRSTransitions', 'DISPID_SRRTTickCount',
    'DISPID_SASCurrentDevicePosition',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SAEventHandle',
    'ISpStream', 'SPSERIALIZEDRESULT', 'eLEXTYPE_RESERVED10',
    'DISPID_SPRsCount', 'DISPID_SLPPhoneIds', 'DISPID_SPIElements',
    'DISPID_SPIAudioSizeBytes', 'SVP_19', 'SpeechTokenIdUserLexicon',
    'SpeechVoiceCategoryTTSRate', 'SPDKL_DefaultLocation',
    'SpeechCategoryAudioIn', 'DISPID_SGRSTWeight',
    'SPEI_PHRASE_START', 'SSSPTRelativeToEnd', 'ISpObjectToken',
    'DISPID_SVAlertBoundary', 'SPEI_MAX_SR', 'SpeechTokenKeyFiles',
    'DISPID_SpeechCustomStream', 'ISpeechPhraseProperties',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPAsItem',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVGetProfiles', 'SPPS_RESERVED3',
    'ISpeechRecognizer', 'SAFT8kHz8BitMono', 'SAFT48kHz16BitStereo',
    'SPPS_NotOverriden', 'SpeechAllElements', 'DISPID_SVEViseme',
    'SAFT22kHz16BitStereo', 'eLEXTYPE_PRIVATE20', 'eLEXTYPE_PRIVATE9',
    'DISPID_SWFEBlockAlign', 'SpeechLexiconType', 'SPGRAMMARSTATE',
    'DISPID_SGRsDynamic', 'ISpeechCustomStream', 'SRADynamic',
    'SpeechCategoryVoices', 'DISPID_SVVolume', 'SAFT8kHz16BitMono',
    'SPSTREAMFORMATTYPE', 'DISPID_SDKOpenKey', 'SVP_15',
    'DISPID_SVSInputSentenceLength', 'SVF_Emphasis', 'SPCS_DISABLED',
    'SP_VISEME_20', 'SVEAudioLevel', 'DISPID_SRGCommit',
    'ISpGrammarBuilder', 'SDKLCurrentUser', 'SAFT24kHz8BitStereo',
    'SpNotifyTranslator', 'SPEI_UNDEFINED',
    'SpeechPropertyResourceUsage', 'DISPID_SPRulesCount', 'SDTAll',
    'SPSHT_OTHER', 'STCInprocHandler',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRId', 'SP_VISEME_2',
    'DISPID_SPPChildren', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechFileStream', 'SDTPronunciation',
    'SSSPTRelativeToStart', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SOTSetId', 'ISpeechPhraseProperty', 'DISPID_SVSPhonemeId',
    'SP_VISEME_13', 'SGDSInactive', 'STSF_AppData',
    'DISPID_SOTCategory', 'SPWORDTYPE', 'SAFTADPCM_22kHzMono',
    'DISPID_SRRDiscardResultInfo', 'SPPHRASEPROPERTY',
    'SPEI_END_SR_STREAM', 'ISpeechRecoContext', 'SAFT16kHz8BitMono',
    'SpeechMicTraining', 'DISPID_SpeechPhraseReplacement',
    'SP_VISEME_5', 'SVEEndInputStream', 'SDTRule', 'SPAR_Medium',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechPhraseInfo',
    '_ISpeechRecoContextEvents', 'SpVoice', 'SRTAutopause',
    'DISPID_SpeechBaseStream', 'ISpRecoResult', 'SPGS_ENABLED',
    'DISPID_SpeechPhoneConverter', 'SPEI_SENTENCE_BOUNDARY',
    'SPAR_Low', 'ISpObjectWithToken', 'SPGS_EXCLUSIVE',
    'DISPID_SRCCreateGrammar',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_RESERVED8',
    'SPSHT_NotOverriden', 'ISpXMLRecoResult', 'SVSFlagsAsync',
    'SAFT16kHz16BitMono', 'DISPID_SpeechRecoContextEvents', 'SVP_17',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRCEPropertyStringChange', 'SSFMOpenForRead',
    'SAFT12kHz16BitMono', 'ISpNotifyTranslator',
    'SpeechPropertyResponseSpeed', 'SFTInput',
    'SpPhoneticAlphabetConverter', 'SAFT48kHz16BitMono',
    'DISPID_SPCIdToPhone', 'SVSFPersistXML', 'DISPID_SLWLangId',
    'SECFDefault', 'SREAdaptation', 'DISPID_SDKEnumKeys',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPPS_Noun',
    'SpeechGrammarTagWildcard', 'SGRSTTEpsilon',
    'DISPID_SWFEChannels', 'SpeechTokenContext', 'SpWaveFormatEx',
    'SLOStatic', 'SITooFast', 'DISPID_SASetState', 'SGRSTTWord',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRRTStreamTime',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SpeechVoiceEvent',
    'SECNormalConfidence', 'SRSInactive', 'DISPID_SVEAudioLevel',
    'DISPID_SLWWord', 'DISPID_SASNonBlockingIO', 'SPBOOKMARKOPTIONS',
    'IEnumSpObjectTokens', 'DISPID_SVIsUISupported', 'SVP_3',
    'ISpAudio', 'SPSMF_SAPI_PROPERTIES', 'SVSFNLPMask',
    'DISPID_SRCRequestedUIType', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SAFGuid', 'ISpeechRecoResultDispatch', 'SpPhoneConverter',
    'ISpStreamFormatConverter', 'SpeechAddRemoveWord', 'SP_VISEME_7',
    'DISPID_SGRSAddRuleTransition', 'SPWF_SRENGINE', 'SPSHT_Unknown',
    'DISPID_SRGCmdLoadFromResource', 'SPBINARYGRAMMAR',
    'DISPID_SGRsCount', 'SDKLCurrentConfig',
    'SpeechDisplayAttributes', 'SVP_10', 'DISPID_SLPs_NewEnum',
    'SAFT11kHz16BitStereo', 'DISPID_SPRuleFirstElement',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPWF_INPUT',
    'SpeechStreamSeekPositionType', 'DISPID_SPIStartTime',
    'SDTProperty', 'DISPID_SPRText', 'SPEI_RECOGNITION',
    'ISpMMSysAudio', 'SAFT12kHz16BitStereo', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SAFSetWaveFormatEx', 'ISpeechObjectToken',
    'ISpeechObjectTokens', 'DISPID_SpeechPhraseAlternates',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpeechPhraseReplacement',
    'DISPID_SRCEHypothesis', 'SSFMCreate', '_SPAUDIOSTATE',
    'DISPID_SGRSAddSpecialTransition', 'SPEI_RESERVED6',
    'DISPID_SBSFormat', 'ISpeechWaveFormatEx', 'SPAR_High',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPPsItem', 'DISPID_SRState',
    'SVP_7', 'ISpNotifySource', 'DISPID_SPRs_NewEnum',
    '_ISpeechVoiceEvents', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRSNumberOfActiveRules', 'SVP_1', 'SVP_21', 'SBONone',
    'tagSPTEXTSELECTIONINFO', 'SpeechAudioFormatType', 'SPSUnknown',
    'SpeechVisemeFeature', 'SPEI_RECO_STATE_CHANGE', 'WAVEFORMATEX',
    'ISpeechVoice', 'eLEXTYPE_PRIVATE14', 'DISPID_SABIEventBias',
    'DISPID_SGRSTsCount', 'DISPID_SGRSTsItem', 'SVP_6',
    'DISPID_SMSGetData', 'SPRECOSTATE',
    'ISpeechGrammarRuleStateTransitions',
    'SpeechDictationTopicSpelling', 'DISPID_SVEPhoneme',
    'DISPID_SMSADeviceId', 'SPWT_LEXICAL',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechTokenShellFolder', 'SPINTERFERENCE_TOOLOUD', 'SPSLMA',
    'eLEXTYPE_APP', 'DISPID_SVSInputSentencePosition',
    'SPGS_DISABLED', 'SPEI_SR_RETAINEDAUDIO', 'ISpStreamFormat',
    'SREBookmark', 'DISPID_SVPause', 'DISPID_SVGetVoices',
    'SP_VISEME_18', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPRFirstElement', 'DISPID_SVSVisemeId',
    'SAFT44kHz16BitStereo', 'SpeechRecoContextState',
    'SpObjectTokenCategory', 'SVP_16', 'SPSVerb', 'ISpSerializeState',
    'SPEI_INTERFERENCE', 'SAFTNoAssignedFormat',
    'DISPID_SpeechPhraseProperty', 'SPRS_INACTIVE',
    'DISPID_SRAudioInputStream', 'ISpEventSink', 'DISPID_SOTCDefault',
    'SPEI_TTS_PRIVATE', 'SVSFParseMask', 'DISPID_SCSBaseStream',
    'DISPID_SPIProperties', 'SRAInterpreter', 'SPLO_DYNAMIC',
    'SVSFPurgeBeforeSpeak', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPRuleChildren', 'SPAR_Unknown', 'SVPAlert', 'SVPOver',
    'ISpRecognizer', 'DISPID_SGRsFindRule', 'ISpeechGrammarRules',
    'DISPID_SPIRetainedSizeBytes', 'SPEI_RESERVED1', 'SP_VISEME_21',
    'eLEXTYPE_PRIVATE6', 'DISPID_SpeechGrammarRule',
    'DISPID_SPEAudioStreamOffset', 'SPSHORTCUTPAIRLIST',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPERequiredConfidence',
    'SPFM_CREATE', 'DISPID_SPEEngineConfidence',
    'DISPID_SDKSetBinaryValue', 'SREPhraseStart', 'SpeechRunState',
    'DISPID_SRCVoice', 'DISPID_SRRTimes', 'SAFT32kHz8BitMono',
    'SPAUDIOSTATUS', 'SPAUDIOOPTIONS', 'SPEVENT',
    'DISPID_SRSClsidEngine', 'DISPID_SGRAttributes', 'ISpRecognizer2',
    'DISPID_SPERetainedSizeBytes', 'SINone', 'SP_VISEME_3',
    'SpeechRecognitionType', 'ISpeechGrammarRuleState',
    'SPSHORTCUTTYPE', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRRGetXMLResult', 'SpeechTokenValueCLSID',
    'DISPID_SpeechAudioStatus', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPIGetText', 'SpeechSpecialTransitionType', 'SRARoot',
    'STCLocalServer', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SpeechRecognizerStatus', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SRSInactiveWithPurge', 'SPRULE', 'ISpeechLexicon',
    'DISPID_SOTsCount', 'DISPID_SOTCEnumerateTokens', 'SSTTDictation',
    'DISPID_SRDisplayUI', 'SWPUnknownWordUnpronounceable',
    'SAFT8kHz16BitStereo', 'SAFT44kHz8BitStereo', 'SVSFIsNotXML',
    'DISPID_SRCEventInterests', 'SRERecoOtherContext',
    'SpeechPropertyHighConfidenceThreshold', 'SpeechRuleAttributes',
    'SPBO_TIME_UNITS', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SpeechRecoResult2',
    'SPRST_INACTIVE', 'SRCS_Disabled', 'eLEXTYPE_PRIVATE12',
    'DISPID_SABufferInfo', 'SVSFNLPSpeakPunc', 'DISPID_SRCBookmark',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SOTGetDescription',
    'DISPID_SOTMatchesAttributes', 'SPEI_RESERVED2',
    'eLEXTYPE_PRIVATE8', 'SP_VISEME_15', 'DISPID_SRCRecognizer',
    'IStream', 'DISPID_SRCCmdMaxAlternates', 'SPVPRI_OVER',
    'DISPID_SpeechObjectToken', 'SASRun', 'SPAO_NONE',
    'SAFTGSM610_22kHzMono', 'eLEXTYPE_RESERVED7', 'SASStop',
    'DISPID_SpeechPhraseProperties', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPWORD', 'SVP_0', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRCEAudioLevel', 'DISPID_SRCSetAdaptationData',
    'DISPID_SpeechGrammarRules', 'ISpeechPhraseReplacements',
    'eLEXTYPE_PRIVATE16', 'DISPID_SGRsCommitAndSave', 'SINoise',
    'SPEI_START_SR_STREAM', 'DISPID_SPRules_NewEnum',
    'DISPID_SRGState', 'SAFT16kHz8BitStereo', 'SREStateChange',
    'SASPause', 'SVP_2', 'DISPID_SPIAudioSizeTime',
    'SPFM_OPEN_READWRITE', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SFSOpen', 'DISPID_SPAsCount', 'eLEXTYPE_PRIVATE19',
    'SpSharedRecognizer', 'SPEI_SOUND_END',
    'DISPID_SpeechPhraseAlternate', 'tagSPPROPERTYINFO',
    'SpeechRecoEvents', 'DISPID_SRSCurrentStreamNumber',
    'SPFM_NUM_MODES', 'SPVPRI_NORMAL', 'SPDKL_LocalMachine',
    'STSF_FlagCreate', 'SPSEMANTICFORMAT', 'SpeechDiscardType',
    'DISPID_SRSAudioStatus', 'SPEI_WORD_BOUNDARY', 'DISPID_SVSpeak',
    'DISPID_SRGId', 'SGDSActiveWithAutoPause',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRSAddWordTransition',
    'ISpRecognizer3', 'ISpPhoneticAlphabetConverter',
    'SDKLLocalMachine', 'SWTAdded', 'DISPID_SOTCId', 'SREPrivate',
    'ISpeechAudioStatus', 'DISPID_SOTCreateInstance',
    'DISPID_SRGReset', 'ISpDataKey', 'DISPID_SGRSTText',
    'SRTExtendableParse', 'SPEI_MIN_TTS', 'SPPS_LMA',
    'ISpeechMMSysAudio', 'DISPID_SPACommit', 'ISpProperties',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechPropertyAdaptationOn', 'DISPID_SMSAMMHandle',
    'SPAO_RETAIN_AUDIO', 'DISPID_SRAudioInput',
    'DISPID_SPIReplacements', 'DISPID_SRGIsPronounceable',
    'SGPronounciation', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFT22kHz8BitStereo', 'DISPID_SAFType',
    'SAFTCCITT_uLaw_22kHzStereo', 'SRATopLevel',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFT16kHz16BitStereo',
    'SDTAudio', 'SVESentenceBoundary', 'DISPID_SPEDisplayAttributes',
    'SpMMAudioEnum', 'DISPID_SRCVoicePurgeEvent',
    'SPEI_FALSE_RECOGNITION', 'SDA_One_Trailing_Space',
    'SREAudioLevel', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SVSkip', 'SPCT_DICTATION', 'DISPID_SGRsItem',
    'DISPID_SLPsCount', 'DISPID_SLWs_NewEnum', 'SAFTADPCM_8kHzStereo',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRCEBookmark',
    'SAFT8kHz8BitStereo', 'DISPID_SPRulesItem',
    'SpeechGrammarRuleStateTransitionType', 'SPPS_Verb',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPPValue', 'SpeechAudioFormatGUIDWave',
    'eLEXTYPE_PRIVATE7', 'SpeechGrammarWordType', 'SP_VISEME_14',
    'DISPID_SRGDictationUnload', 'DISPID_SVStatus', 'SPFILEMODE',
    'SAFT24kHz16BitMono', 'ISpeechAudioFormat', 'SPEI_REQUEST_UI',
    'ISpeechPhraseRules', 'DISPID_SRIsUISupported',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPCT_SUB_DICTATION',
    'DISPID_SOTGetStorageFileName', 'SpeechEngineProperties',
    'ISpeechRecoResult2', 'SAFT44kHz8BitMono', 'SpeechFormatType',
    'IEnumString', 'SPINTERFERENCE', 'SpMemoryStream', 'SP_VISEME_12',
    'DISPID_SGRClear', 'SPSMF_UPS', 'eLEXTYPE_USER',
    'SAFT48kHz8BitStereo', 'SPEI_ADAPTATION', 'DISPID_SVEBookmark',
    'SREHypothesis', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRGetPropertyString', 'DISPID_SVSInputWordPosition',
    'ISpRecoContext2', 'SPXRO_Alternates_SML',
    'DISPID_SOTIsUISupported', 'DISPID_SOTId',
    'DISPID_SpeechRecognizer', 'SRCS_Enabled', 'DISPID_SVSLastResult',
    'SP_VISEME_17', 'SREStreamStart', 'DISPID_SPEsCount',
    'SpeechUserTraining', 'ISpeechGrammarRule',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SLWPronunciations',
    'DISPID_SABufferNotifySize', 'DISPID_SOTCGetDataKey',
    'SVSFParseSapi', 'SAFT32kHz16BitStereo', 'SVP_20',
    'SpeechInterference', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRGRecoContext', 'SP_VISEME_11', 'SPTEXTSELECTIONINFO',
    'DISPID_SRStatus', 'ISequentialStream', 'DISPID_SpeechMMSysAudio',
    'SWPUnknownWordPronounceable', 'SpPhraseInfoBuilder',
    'SPPS_RESERVED2', 'DISPID_SPPNumberOfElements', 'SpeechRuleState',
    'SPLEXICONTYPE', 'ISpeechTextSelectionInformation',
    'DISPID_SRGCmdSetRuleState', 'SPVPRI_ALERT',
    'SpSharedRecoContext', 'SGSExclusive', 'SREFalseRecognition',
    'DISPIDSPTSI', 'DISPID_SPEAudioSizeTime', 'SVF_None',
    'DISPID_SRGCmdLoadFromFile', 'SREInterference',
    'SPINTERFERENCE_NONE', 'DISPID_SRSetPropertyNumber',
    'SpTextSelectionInformation', 'SPVISEMES',
    'DISPID_SRRRecoContext', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechPhraseElement', 'SPRECORESULTTIMES', 'SPWT_DISPLAY',
    'DISPID_SLGenerationId', 'ISpeechAudioBufferInfo',
    'DISPID_SpeechLexiconWords', 'SASClosed', 'SVP_8',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRRAudioFormat',
    'SpeechVoiceSkipTypeSentence', 'SpCustomStream',
    'eLEXTYPE_PRIVATE18', 'SLTApp', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_MIN_SR',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SOTCSetId',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SLTUser',
    'tagSTATSTG', 'SP_VISEME_6', 'SRTStandard',
    'SpNullPhoneConverter', 'SPEVENTENUM',
    'SpeechCategoryPhoneConverters', 'DISPID_SASState',
    'DISPIDSPTSI_SelectionOffset', 'SPLO_STATIC',
    'ISpObjectTokenCategory', 'SDTDisplayText', 'SDTReplacement',
    'DISPID_SPAs_NewEnum', 'STCInprocServer', 'SPFM_CREATE_ALWAYS',
    'SRTReSent', 'SPEI_VISEME', 'DISPID_SRCState',
    'DISPID_SRRTOffsetFromStart', 'SAFTCCITT_uLaw_44kHzMono',
    'SRSEIsSpeaking', 'SRAImport', 'SAFTGSM610_8kHzMono',
    'SpeechLoadOption', 'SPFM_OPEN_READONLY',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPIEnginePrivateData',
    'SPWT_PRONUNCIATION', 'DISPID_SGRInitialState',
    'DISPID_SPRuleEngineConfidence', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPANumberOfElementsInResult', 'SpeechBookmarkOptions',
    'eLEXTYPE_PRIVATE13', 'SITooSlow', 'DISPID_SRGRules',
    'DISPID_SDKGetStringValue', 'SpeechCategoryRecoProfiles',
    'IInternetSecurityManager', 'SPSNotOverriden',
    'DISPID_SpeechMemoryStream', 'DISPID_SPEDisplayText',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRGetRecognizers',
    'DISPID_SRGDictationLoad', 'DISPID_SGRsCommit',
    'DISPID_SpeechLexicon', 'eLEXTYPE_PRIVATE5', 'SECLowConfidence',
    'eLEXTYPE_PRIVATE2', 'DISPID_SOTsItem', 'SITooLoud',
    'SECHighConfidence', 'SPBO_PAUSE', 'eLEXTYPE_LETTERTOSOUND',
    'ISpPhraseAlt', 'DISPID_SpeechObjectTokens', 'SRERecognition',
    'DISPID_SOTs_NewEnum', 'STCAll', 'SVEBookmark', 'SVP_12',
    'SECFIgnoreCase', '__MIDL_IWinTypes_0009',
    'DISPID_SPRuleNumberOfElements', 'eLEXTYPE_PRIVATE1',
    'DISPID_SOTDataKey', 'DISPID_SBSSeek', 'eWORDTYPE_ADDED',
    'DISPID_SLWsItem', 'DISPID_SRCRetainedAudio',
    'DISPID_SRCERequestUI', 'UINT_PTR', 'SpeechRetainedAudioOptions',
    'SPPS_Modifier', 'SpeechTokenKeyUI', 'SPSInterjection',
    'SpeechRecognizerState', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRRPhraseInfo', 'DISPID_SAVolume',
    'ISpeechLexiconPronunciations', 'DISPID_SOTRemoveStorageFileName',
    'SAFTDefault', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechMemoryStream', 'DISPID_SPPs_NewEnum',
    'DISPID_SASCurrentSeekPosition', 'SP_VISEME_10',
    'SpeechPartOfSpeech', 'DISPID_SVEVoiceChange',
    'DISPID_SVEStreamEnd', 'DISPID_SREmulateRecognition', 'SVEViseme',
    'SVSFIsXML', 'SpStream', 'SPPARTOFSPEECH', 'DISPID_SBSWrite',
    'DISPID_SRRGetXMLErrorInfo', 'SPCT_SUB_COMMAND',
    'SAFTADPCM_44kHzMono', 'SGRSTTRule', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SVEWord', 'DISPID_SpeechWaveFormatEx', 'DISPID_SLWsCount',
    'DISPID_SGRName', 'DISPID_SLAddPronunciation',
    'DISPID_SGRSTPropertyName', 'SGRSTTWildcard',
    'DISPID_SLPSymbolic', 'DISPID_SpeechVoice', 'SP_VISEME_19',
    'SPGRAMMARWORDTYPE', 'eLEXTYPE_MORPHOLOGY',
    'SAFTCCITT_ALaw_44kHzMono', 'SPSNoun', 'SVP_18',
    'SAFTADPCM_11kHzMono', 'SDKLDefaultLocation',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRCAudioInInterferenceStatus', 'SPSHT_EMAIL', 'SRSEDone',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SVF_Stressed',
    'SAFT11kHz8BitStereo', 'DISPID_SPRuleConfidence',
    'SpCompressedLexicon', 'DISPID_SRGetFormat', 'SRTEmulated',
    'SGRSTTDictation', 'ISpEventSource', 'DISPID_SRSetPropertyString',
    'DISPID_SRCEPhraseStart', 'SPEI_HYPOTHESIS',
    'SPADAPTATIONRELEVANCE', 'SpeechRecoProfileProperties',
    'SAFTADPCM_8kHzMono', 'SAFT22kHz8BitMono',
    'DISPID_SpeechLexiconProns', 'DISPID_SRGDictationSetState',
    'SPCATEGORYTYPE', 'SAFT32kHz16BitMono',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPRST_ACTIVE_ALWAYS',
    'SREAllEvents', 'eLEXTYPE_PRIVATE3', 'SPCONTEXTSTATE',
    'SPCS_ENABLED', 'SPSEMANTICERRORINFO', 'ISpeechPhraseElements',
    'STCRemoteServer', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpFileStream', 'SpMMAudioOut', 'SPCT_SLEEP',
    'DISPID_SGRSTNextState', 'SpeechCategoryRecognizers',
    'DISPID_SGRSRule', 'SPXMLRESULTOPTIONS', 'DISPID_SOTDisplayUI',
    'SPPS_RESERVED4', 'DISPID_SPILanguageId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SMSSetData', 'DISPID_SVEventInterests',
    'DISPID_SVSInputWordLength', 'eLEXTYPE_PRIVATE17', 'SVEPhoneme',
    'DISPID_SRGCmdSetRuleIdState', 'STSF_CommonAppData', 'SVP_13',
    'SPPHRASERULE', 'SPEI_SOUND_START', 'ISpeechAudio',
    'DISPID_SVPriority', 'SP_VISEME_1', 'SGDSActiveUserDelimited',
    'DISPID_SRCPause', 'SPRST_NUM_STATES', 'DISPID_SpeechAudio',
    'SPPS_Interjection', 'DISPID_SFSClose', 'SAFT24kHz8BitMono',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_RESERVED9',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFT44kHz16BitMono',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechLexiconWord',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SVAudioOutputStream',
    'SPLOADOPTIONS', 'DISPID_SVEEnginePrivate',
    'SpeechRegistryUserRoot', 'DISPID_SRSSupportedLanguages',
    'SDA_Consume_Leading_Spaces', 'ISpRecoContext',
    'SpeechVoiceSpeakFlags', 'SpeechGrammarTagDictation',
    'SSTTTextBuffer', 'SVSFUnusedFlags', 'DISPID_SRCEStartStream',
    'DISPID_SPIRule', 'ISpeechPhraseAlternates', 'SPEI_MAX_TTS',
    'DISPID_SVSRunningState', 'SP_VISEME_8', 'DISPID_SPRuleParent',
    'SpObjectToken', 'ISpeechPhoneConverter', 'SSTTWildcard',
    'DISPIDSPTSI_SelectionLength', 'SVSFVoiceMask',
    'DISPID_SRRSetTextFeedback', 'DISPID_SLGetWords',
    'SPSHORTCUTPAIR', 'SREStreamEnd', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SBSRead', 'DISPID_SOTGetAttribute',
    'DISPID_SWFEBitsPerSample', 'SVP_4', 'DISPID_SPPId',
    'SPEI_SR_PRIVATE', 'eWORDTYPE_DELETED', 'SpeechDataKeyLocation',
    'SpResourceManager', 'DISPID_SVWaitUntilDone', 'DISPID_SRRAudio',
    'SVEPrivate', 'SAFT11kHz8BitMono', 'SPWORDPRONUNCIATION',
    'ISpeechObjectTokenCategory', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SDKDeleteKey', 'SpeechVoicePriority', 'ISpeechBaseStream',
    'SPPHRASE', 'SPRECOGNIZERSTATUS', 'SPAS_PAUSE',
    'SpeechTokenKeyAttributes', 'DISPID_SRCResume',
    'SpInProcRecoContext', 'SPSERIALIZEDPHRASE',
    'DISPID_SPAPhraseInfo', 'SPRECOCONTEXTSTATUS', 'SGSEnabled',
    'DISPID_SGRSTType', 'DISPID_SPPConfidence', 'ISpRecoCategory',
    'SpeechAudioProperties', 'SAFT11kHz16BitMono',
    'DISPID_SPRNumberOfElements', 'SPEI_RESERVED5', 'DISPID_SVRate',
    'DISPID_SRCESoundEnd', 'SSFMCreateForWrite',
    'DISPID_SRGSetTextSelection', 'SAFT12kHz8BitMono',
    'SpeechGrammarState', 'DISPID_SLRemovePronunciation', 'SPAS_RUN',
    'SpInprocRecognizer', 'Speech_Max_Pron_Length',
    '_RemotableHandle', 'SPEI_END_INPUT_STREAM', 'DISPID_SLPType',
    'SpShortcut', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechGrammarTagUnlimitedDictation', 'SAFTADPCM_44kHzStereo',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCEAdaptation',
    'SRAORetainAudio', 'SPDKL_CurrentUser', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPARecoResult', 'ISpeechLexiconPronunciation',
    'DISPID_SGRSTRule', 'DISPID_SPPParent', 'ISpPhoneConverter',
    'DISPID_SPELexicalForm', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPRuleId', 'DISPID_SpeechRecoContext',
    'ISpeechGrammarRuleStateTransition', 'SRTSMLTimeout',
    'DISPID_SVSpeakStream', 'DISPID_SRCEEndStream',
    'ISpeechRecoResult', 'DISPID_SDKGetlongValue',
    'DISPID_SVAudioOutput', 'DISPID_SPEs_NewEnum', 'SpAudioFormat',
    'SRADefaultToActive', 'SECFNoSpecialChars', 'SECFIgnoreWidth',
    'DISPID_SRProfile', 'SPAUDIOBUFFERINFO', 'SRAONone',
    'DISPID_SpeechPhraseRule', 'DISPID_SDKEnumValues',
    'DISPID_SADefaultFormat', 'SpUnCompressedLexicon',
    'DISPID_SPISaveToMemory', 'DISPID_SPAStartElementInResult',
    'DISPID_SRCreateRecoContext', 'SPVPRIORITY', 'ISpeechRecoGrammar',
    'SPRS_ACTIVE', 'ISpPhrase', 'SPEVENTSOURCEINFO',
    'DISPID_SPEActualConfidence', 'DISPID_SDKCreateKey',
    'eLEXTYPE_VENDORLEXICON', 'ISpVoice', 'SAFT12kHz8BitStereo',
    'SRESoundStart', 'DISPID_SAStatus', 'DISPID_SRRTLength',
    'DISPID_SRCEInterference', 'SINoSignal',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPDKL_CurrentConfig',
    'DISPID_SLGetGenerationChange', 'Speech_StreamPos_RealTime',
    'DISPID_SDKGetBinaryValue', 'ISpRecoGrammar2',
    'SpeechVoiceEvents', 'SECFIgnoreKanaType', 'SPPS_Unknown',
    'SREPropertyNumChange', 'DISPID_SPRsItem', 'ISpNotifySink',
    'SPEI_SR_BOOKMARK', 'ISpeechXMLRecoResult',
    'ISpPhoneticAlphabetSelection', 'DISPID_SpeechAudioFormat',
    'SpeechStreamFileMode', 'DISPID_SVSLastBookmark',
    'DISPID_SVEStreamStart', 'SDA_No_Trailing_Space',
    'DISPID_SPPsCount', 'SFTSREngine', 'ISpeechPhraseElement',
    'SAFTText', 'ISpeechFileStream', 'DISPID_SpeechRecoResult',
    'SVEVoiceChange', 'SPPS_RESERVED1', 'DISPID_SPRDisplayAttributes',
    'IInternetSecurityMgrSite', 'SPRST_INACTIVE_WITH_PURGE',
    'SPSFunction', 'SpStreamFormatConverter', 'SITooQuiet',
    'SpeechWordPronounceable', 'SPSModifier', 'SPEI_RESERVED3',
    'SBOPause', 'eLEXTYPE_RESERVED6', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SVPNormal', 'STSF_LocalAppData', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SOTRemove', 'DISPID_SRCEEnginePrivate', 'SPPHRASEELEMENT',
    'SPPROPERTYINFO', 'ISpeechPhraseAlternate',
    'SpeechCategoryAudioOut', 'SAFT48kHz8BitMono', 'SGSDisabled',
    'DISPID_SGRsAdd', 'SDTLexicalForm', 'DISPID_SPIGrammarId',
    'DISPID_SPPFirstElement', 'SRSActive',
    'SPEI_PROPERTY_STRING_CHANGE', 'SP_VISEME_0',
    'SAFTNonStandardFormat', 'ISpeechLexiconWords', 'SPSSuppressWord',
    'SVP_9', 'DISPID_SpeechDataKey', 'SpeechVisemeType',
    'DISPID_SAFGetWaveFormatEx', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPIGetDisplayAttributes', 'SPEI_PHONEME',
    'Speech_StreamPos_Asap', 'SDTAlternates',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPIEngineId',
    'SpeechAudioVolume', 'DISPID_SVDisplayUI', 'DISPID_SLWType',
    'SAFT32kHz8BitStereo', 'SPCT_COMMAND', 'DISPID_SLPLangId',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRRAlternates',
    'SPPS_Function', 'DISPID_SABIMinNotification',
    'DISPID_SRCERecognition', 'DISPID_SRIsShared', 'SPRST_ACTIVE',
    'DISPID_SWFEExtraData', 'SVEStartInputStream',
    'eLEXTYPE_PRIVATE10', 'ISpeechResourceLoader',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRRSpeakAudio',
    'DISPID_SWFEFormatTag', 'DISPID_SPPEngineConfidence',
    'SREPropertyStringChange', 'DISPID_SVResume',
    'DISPID_SRCESoundStart', 'DISPID_SGRSTPropertyId', 'SPRULESTATE',
    'SVP_14', 'SP_VISEME_16', 'DISPID_SGRAddResource',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechRecoResultTimes',
    'SECFEmulateResult', 'SPAUDIOSTATE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechCategoryAppLexicons', 'SPPS_Noncontent',
    'ISpeechPhraseRule', 'SpeechEngineConfidence', 'SP_VISEME_9',
    'SPXRO_SML', 'SPEI_VOICE_CHANGE', 'SPWORDLIST',
    'DISPID_SpeechVoiceStatus', 'ISpLexicon',
    'DISPID_SRRSaveToMemory', 'ISpeechVoiceStatus',
    'SAFTGSM610_44kHzMono', 'SVP_5', 'SGRSTTTextBuffer',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVVoice', 'SVEWordBoundary',
    'SSFMOpenReadWrite', 'SpeechAudioFormatGUIDText', 'ISpShortcut',
    'SP_VISEME_4', 'DISPID_SGRAddState'
]

_check_version('1.2.0', 1718599291.250876)
